...
public class Ostostapahtumat {
    ...
    private static Ostostapahtumat instance;

    public static Ostostapahtumat create(OstostapahtumaDAOMongo dao) {
        instance = new Ostostapahtumat(dao);
        return instance;
    }
    
    public static Ostostapahtumat getInstance(){
        return instance;
    }    
    
    private Ostostapahtumat(OstostapahtumaDAOMongo dao) {
        this.dao = dao;
    }
